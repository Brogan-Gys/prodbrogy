  ...
  return (
    <div
      className={cn(
        ...
        tone === "dark" && "bg-white text-ink shadow-hard-sm sm:shadow-hard",
        tone === "saved" && "bg-white text-ink shadow-hard-sm sm:shadow-hard",
        tone === "coral" && "bg-ink text-bone shadow-hard-sm-soft sm:shadow-hard-soft",
        tone === "volt" && "bg-ink text-bone shadow-hard-sm-soft sm:shadow-hard-soft",
        tone === "stash" && "bg-white text-ink shadow-hard-sm sm:shadow-hard"
      )}
    >
