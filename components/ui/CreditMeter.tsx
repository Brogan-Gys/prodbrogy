...
const highlightClass = "bg-cyan text-stamp shadow-hard-lg -translate-y-1";
      ...
      <div id="credits" className={cn(cardClass, isHighlighted && highlightClass)}>
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            type="button"
            onClick={openSignIn}
            className="inline-flex h-8 shrink-0 items-center gap-1.5 border-2 border-ink bg-volt text-stamp px-2.5 font-display text-[11px] font-black uppercase transition hover:-translate-y-0.5"
          >
  ...
  return (
    <div id="credits" className={cn(cardClass, isHighlighted && highlightClass)}>
      ...
      <div className="mt-3 h-4 border-2 border-ink bg-bone">
        <div className="h-full bg-volt text-stamp transition-all" style={{ width: `${percent}%` }} />
      </div>
