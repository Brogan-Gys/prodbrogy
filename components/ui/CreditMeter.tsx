    ...
    return (
      ...
      >
        ...
        <p className="mt-2 text-xs font-bold uppercase text-ink/55">
          Sign in for {DAILY_CREDIT_LIMIT} credits a day, plus {SOCIAL_CREDIT_BONUS} more per social link.
        </p>
        <button
          type="button"
          onClick={openSignIn}
          className="mt-3 inline-flex h-9 items-center gap-1.5 border-2 border-ink bg-volt px-3 font-display text-xs font-black uppercase transition hover:-translate-y-0.5"
        >
